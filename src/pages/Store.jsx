  ...
  return (
    <div className='flex flex-col justify-center bg-orange-100'>
      <div className='flex justify-between items-center px-20 py-5'>
        <h1 className='text-2xl uppercase font-bold mt-10 text-center mb-10'>Store</h1>
      </div>
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-10'>
        {
          products.map(product => (
            <div key={product.id} className='flex flex-col items-center bg-white shadow-md rounded-lg px-2 py-2'>
              <img src={product.image} alt={product.image} className='rounded-md h-48' />
              <div className='mt-4'>
