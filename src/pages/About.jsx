        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 text-center m-auto lg:max-w-[1260px]">
          ...
          <div className="p-6 flex flex-col justify-center text-left">
            ...
            <p className="py-4">
              ...
              karena Xiaomi menghadapi banyak tantangan yang tampaknya mustahil
              dihadapi pada awal perjalanan kami.had seemed impossible to defy
              in our early days.
            </p>
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 px-5 pt-10 justify-center">
        <div className=" background-text-images m-auto text-center bg-cover lg:max-w-[1260px]">
          ...
          <p className="font-Inter text-base text-white px-8 pb-8 mx-10">
            ...
            visi kami "Menjadikan pengguna sebagai teman dan menjadi perusahaan
            yang paling disukai di hati pengguna", Xiaomi terus berupaya
            mengejar inovasi, pengalaman pengguna berkualitas tinggi, dan
            efisiensi pengoperasian. Perusahaan ini terus meluncurkan
            ...
            tersedia di lebih dari 100 negara dan wilayah di seluruh dunia. Pada
            bulan Agustus 2022, perusahaan masuk dalam daftar Fortune Global 500
            untuk keempat kalinya dengan menempati peringkat ke-266, naik 72
            posisi dibandingkan tahun 2021. Xiaomi terdaftar di Hang Seng Index,
            Hang Seng China Enterprises Index, Hang Seng TECH Index, dan Hang
            Seng China 50 Index.
          </p>
        </div>
      </section>
      <section className="grid grid-cols-1 px-5 py-10 ">
        <div className="bg-cover text-center m-auto lg:max-w-[1260px]">
          ...
          <p className="font-Inter text-base text-black px-8 pb-8">
            ...
            Nyatanya, banyak karyawan Xiaomi yang merupakan penggemar Mi sebelum
            bergabung dalam tim. Sebagai tim, kami berupaya bersama mewujudkan
            kesempurnaan, menyempurnakan dan meningkatkan produk kami demi
            memberikan pengalaman pengguna yang terbaik. Kami juga tidak takut
            dalam menguji gagasan-gagasan baru dan mendobrak keterbatasan kami
            sendiri. Dedikasi dan keyakinan kami terhadap inovasi, bersama
            dengan dukungan dari penggemar Mi, merupakan kekuatan pendorong di
            balik produk Mi unik kami.
          </p>
        </div>
      </section>
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 text-center m-auto lg:max-w-[1260px]">
          <div className="p-4 flex flex-col justify-center">
            ...
            <p className="py-4 text-left">
              Kami sangat egaliter, terbuka, dan inovatif. Tidak ada rapat yang
              perlu waktu lama. Tidak ada proses yang panjang. Kami menyediakan
              lingkungan yang ramah dan kolaboratif untuk mengembangkan
              kreativitas.
            </p>
          </div>
          <div className="p-4 ">
      ...
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 text-center m-auto lg:max-w-[1260px]">
          ...
          <div className="p-4 flex flex-col justify-center text-left">
            ...
            <p className="py-4">
              Xiaomi memiliki banyak talenta hebat! Kompetisi yang ramah membuat
              tim Mi memamerkan kepiawaian mereka dalam basket, renang,
              badminton, dan lainnya. “Mi Idol” tahunan juga telah mengungkap
              banyak potensi hebat.
            </p>
          </div>
        </div>
      </section>
      <section className="grid grid-cols-1 px-5 pt-10 justify-center mb-[48px]">
        <div className=" background-text-images m-auto text-center bg-cover lg:max-w-[1260px]">
          ...
          <p className="font-Inter text-base text-white px-8 pb-8">
            ...
            keras, dan layanan. Banyak dari karyawan kami pada awalnya merupakan
            penggemar produk Mi sebelum mereka memutuskan untuk bergabung dengan
            kami. Tim kami tidak hanya sangat antusias dengan teknologi, tetapi
            juga terus berupaya untuk mencapai kesempurnaan untuk mendobrak
            pandangan kuno dan batas-batas, semuanya hanya untuk memastikan
            produk kami tetap unik dan menawarkan pengalaman pengguna yang tiada
            duanya.
          </p>
