...
const LongCard = (props) => {
    ...
    return (
        <div className="md:mx-2">
            <div className="flex flex-col items-center font-inter pt-10 px-5 text-center gap-2 bg-[#ffffff] xl:w-[940px] md:w-[700px]  md:max-h-[492px] md:relative md:hover:shadow-lg md:hover:ease-out md:duration-[250ms]" onClick="window.location.href = '/product/#'">
