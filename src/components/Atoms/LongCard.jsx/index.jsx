...
const LongCard = (props) => {
    ...
    return (
        <div className="flex flex-col items-center relative">
            <div className="flex flex-col items-center font-inter pt-10 px-5 text-center gap-2 bg-[#ffffff] md:w-[890px] md:max-h-[492px] md:relative md:hover:shadow-lg md:hover:ease-out md:duration-[250ms]" onClick="window.location.href = '/product/#'">
