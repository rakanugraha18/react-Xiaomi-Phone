...
const LongCard = (props) => {
  ...
  return (
    <div className="md:mx-2">
      <div
        className="flex flex-col items-center font-inter pt-10 px-5 text-center gap-2 bg-[#ffffff] xl:w-[700px] md:w-[940px]  md:max-h-[492px] md:relative md:hover:shadow-lg md:hover:ease-out md:duration-[250ms]"
      ...
      >
        ...
        <div className="font-normal text-[14px] leading-[17px] py-4 mt-3">
          <button href="#" disabled>
            <span
              className={`text-[#8998BB] font-normal text-[15px] leading-[18px] md:bg-[#D0D0D0] ${classname} md:rounded-lg md:p-2 md:px-5 md:text-[18px] md:leading-[22px]`}
            >
        ...
        <picture className="md:flex md:items-center md:justify-center md:mt-0">
          <img
            src={`${PhonePic}`}
            alt="phone2"
            className="h-[226px] w-[226px] md:h-[260px] md:w-[260px]"
          />
        </picture>
      </div>
    </div>
