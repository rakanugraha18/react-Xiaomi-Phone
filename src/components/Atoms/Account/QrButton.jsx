...
const QrButton = () => {
  return (
    <div class="qr-switch-wrap"><div class="mi-qr-account-switch"><span role="img" class="anticon mi-qr-account-switch__icon">
        <svg width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" focusable="false" class="">
