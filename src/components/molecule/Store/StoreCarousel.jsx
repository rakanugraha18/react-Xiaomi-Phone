    ...
    <div className="relative h-56 sm:h-64 xl:h-80 2xl:h-96 object-fill">
      <Carousel>
        <div className="relative">
          ...
          <div className="border-box flex flex-col left-[20%] top-[40%] absolute z-2">
            <span className="font-semibold text-slate-100 pb-1 text-2xl md:text-3xl lg:text-6xl">
              Xiaomi 13T
            </span>
            <span className="font-base text-slate-100 text-xs md:text-lg lg:text-xl">
        ...
        <div className="relative">
          ...
          <div className="border-box flex flex-col left-[55%] top-[40%] absolute z-2 text-center sm:center sm:text-left">
            <span className="font-semibold pb-1 text-2xl md:text-3xl lg:text-6xl">
              Xiaomi 12T 5G
            </span>
            <span className="font-base text-sm md:text-lg lg:text-xl">
